    ...
    var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        j = function(t) {
            ...
            return m(e, t), e.prototype.addNamespaces = function(t) {
                ...
                var l = i(this.data, u) || {};
                r ? s(l, n, a) : l = y({}, l, n), o(this.data, u, l), this.emit("added", t, e, n)
        ...
        N = function(t) {
            ...
            return m(n, t), n.prototype.changeLanguage = function(t) {
                ...
                if ("object" !== ("undefined" == typeof n ? "undefined" : d(n)) && (n = this.options.overloadTranslationOptionHandler(arguments)), void 0 === t || null === t || "" === t) return "";
                "number" == typeof t && (t = String(t)), "string" == typeof t && (t = [t]);
                var o = n.keySeparator || this.options.keySeparator || ".",
                ...
                if (f && b && v.indexOf(h) < 0 && (!m || "[object Array]" !== h)) {
                    if (!n.returnObjects && !this.options.returnObjects) return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(g, f, n) : "key '" + i + " (" + this.language + ")' returned an object instead of string.";
                    if (n.keySeparator || this.options.keySeparator) {
                        var x = "[object Array]" === h ? [] : {};
                        for (var k in f) Object.prototype.hasOwnProperty.call(f, k) && (x[k] = this.translate("" + g + o + k, y({}, n, {
                            joinArrays: !1,
                            ns: s
                        })));
                        f = x
                    }
                } else if (m && "[object Array]" === h) f = f.join(m), f && (f = this.extendTranslation(f, t, n));
                else {
                    var S = !1,
                        w = !1;
                    this.isValidLookup(f) || void 0 === n.defaultValue || (S = !0, f = n.defaultValue), this.isValidLookup(f) || (w = !0, f = i);
                    var O = n.defaultValue && n.defaultValue !== f && this.options.updateMissing;
                    if (w || S || O) {
                        this.logger.log(O ? "updateKey" : "missingKey", u, a, i, O ? n.defaultValue : f);
                        var L = [],
                        ...
                        if ("fallback" === this.options.saveMissingTo && R && R[0])
                            for (var j = 0; j < R.length; j++) L.push(R[j]);
                        ...
                        var C = function(t, o) {
                            e.options.missingKeyHandler ? e.options.missingKeyHandler(t, a, o, O ? n.defaultValue : f, O) : e.backendConnector && e.backendConnector.saveMissing && e.backendConnector.saveMissing(t, a, o, O ? n.defaultValue : f, O), e.emit("missingKey", t, a, o, f)
                        };
                        this.options.saveMissing && (this.options.saveMissingPlurals && n.count ? L.forEach(function(t) {
                    ...
                    f = this.extendTranslation(f, t, n), w && f === i && this.options.appendNamespaceToMissingKey && (f = a + ":" + i), w && this.options.parseMissingKeyHandler && (f = this.options.parseMissingKeyHandler(f))
                }
                return f
                ...
                return void 0 !== t && s && s.length && n.applyPostProcessor !== !1 && (t = C.handle(s, t, e, n, this)), t
                            ...
                            e.isValidLookup(o) || c.forEach(function(r) {
                                if (!e.isValidLookup(o)) {
                                    var i = s,
                                        a = [i],
                                        c = void 0;
                                    u && (c = e.pluralResolver.getSuffix(r, n.count)), u && l && a.push(i + c), l && a.push(i += "" + e.options.contextSeparator + n.context), u && a.push(i += c);
        ...
        E = function() {
            ...
            return t.prototype.getScriptPartFromCode = function(t) {
                ...
                if ("string" == typeof t && t.indexOf("-") > -1) {
                    ...
                    }) : 2 === n.length ? (n[0] = n[0].toLowerCase(), n[1] = n[1].toUpperCase(), e.indexOf(n[1].toLowerCase()) > -1 && (n[1] = l(n[1].toLowerCase()))) : 3 === n.length && (n[0] = n[0].toLowerCase(), 2 === n[1].length && (n[1] = n[1].toUpperCase()), "sgn" !== n[0] && 2 === n[2].length && (n[2] = n[2].toUpperCase()), e.indexOf(n[1].toLowerCase()) > -1 && (n[1] = l(n[1].toLowerCase())), e.indexOf(n[2].toLowerCase()) > -1 && (n[2] = l(n[2].toLowerCase()))), n.join("-")
                }
        ...
        U = function() {
            ...
            return e.prototype.init = function() {
                ...
                e && (this.options = t, this.format = t.interpolation && t.interpolation.format || function(t) {
                    return t
                }, this.escape = t.interpolation && t.interpolation.escape || u), t.interpolation || (t.interpolation = {
                    escapeValue: !0
                });
                ...
                for (this.resetRegExp(), l = 0;
                    (a = this.regexpUnescape.exec(e)) && (u = c(a[1].trim()), e = e.replace(a[0], u), this.regexpUnescape.lastIndex = 0, l++, !(l >= this.maxReplaces)););
                for (l = 0;
                    (a = this.regexp.exec(e)) && (u = c(a[1].trim()), "string" != typeof u && (u = t(u)), u || (this.logger.warn("missed to pass in variable " + a[1] + " for interpolating " + e), u = ""), u = r(this.escapeValue ? this.escape(u) : u), e = e.replace(a[0], u), this.regexp.lastIndex = 0, l++, !(l >= this.maxReplaces)););
                return e
        ...
        T = function(t) {
            ...
            return m(e, t), e.prototype.queueLoad = function(t, e, n) {
                ...
                var o = this,
                    ...
                    a = s[0],
                    u = s[1];
                e && this.emit("failedLoading", a, u, e), n && this.store.addResourceBundle(a, u, n), this.state[t] = e ? -1 : 2, this.queue.forEach(function(n) {
                    r(n.loaded, [a], u), p(n.pending, t), e && n.errors.push(e), 0 !== n.pending.length || n.done || (o.emit("loaded", n.loaded), n.done = !0, n.errors.length ? n.callback(n.errors) : n.callback())
                ...
                return t.length ? this.backend[n](t, e, function(a, u) {
                    return a && u && o < 5 ? void setTimeout(function() {
        ...
        F = function(t) {
            ...
            return m(e, t), e.prototype.init = function() {
                ...
                if ("function" == typeof n && (o = n, n = {}), this.options = y({}, f(), this.options, g(n)), this.format = this.options.interpolation.format, o || (o = h), !this.options.isClone) {
                    ...
                    i.logger = O, i.resourceStore = this.store, i.resourceStore.on("added removed", function(t, e) {
                    ...
                    }), i.interpolator = new U(this.options), i.backendConnector = new T(t(this.modules.backend), i.resourceStore, i, this.options), i.backendConnector.on("*", function(t) {
                        ...
                        i.cacheConnector.save()
                    }), i.cacheConnector = new V(t(this.modules.cache), i.resourceStore, i, this.options), i.cacheConnector.on("*", function(t) {
                        for (var n = arguments.length, o = Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++) o[r - 1] = arguments[r];
                        e.emit.apply(e, [t].concat(o))
                ...
                return "backend" === t.type && (this.modules.backend = t), "cache" === t.type && (this.modules.cache = t), ("logger" === t.type || t.log && t.warn && t.error) && (this.modules.logger = t), "languageDetector" === t.type && (this.modules.languageDetector = t), "postProcessor" === t.type && C.addPostProcessor(t), "3rdParty" === t.type && this.modules.external.push(t), this
