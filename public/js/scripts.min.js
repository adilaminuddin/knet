...
function headerfooter() {
    $("#header").load("header", function(t, e, i) {
    ...
    }), $("#footer").load("footer", function(t, e, i) {
        $('#drop-lng [data-lng="' + localStorage.getItem("lng") + '"]').addClass("xpto active"), $("#drop-lng label").click(function(t) {
            t.preventDefault(), localStorage.setItem("lng", $(this).attr("data-lng")), location.reload(!0)
        })
    })
...
document.addEventListener("DOMContentLoaded", function() {
        "use strict";
        loadWindowSettings(), loadWindowEvents(), loadMenu(), loadTabs(), izotope(), popup(), accordion(), loadTooltips(), initSliderUI(), loadCountdown(), speacialCount(), loadSkills(), misc(), slick(), listenSlick(), loader(), backtotop(), owldemo(), isotope(), livechat(), contactform(), popover(), scrollgoto(), active(), display(), switching(), switchVisible()
...
function speacialCount() {
    $("#specialclock").countdown("2020/12/2", function(t) {
